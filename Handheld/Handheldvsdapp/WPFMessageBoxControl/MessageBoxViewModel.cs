...
using WPFMessageBoxControl.Commands;

namespace WPFMessageBoxControl
{
    public class MessageBoxViewModel : INotifyPropertyChanged
    {
        ...
        {
            string __Source = "pack://application:,,,/WPFMessageBoxControl;component/Images/Default.png";
            switch (image)
            {
                case WPFMessageBoxImage.Alert:
                    __Source = "pack://application:,,,/WPFMessageBoxControl;component/Images/Alert.png";
                    break;
                case WPFMessageBoxImage.Error:
                    __Source = "pack://application:,,,/WPFMessageBoxControl;component/Images/Error.png";
                    break;
                case WPFMessageBoxImage.Information:
                    __Source = "pack://application:,,,/WPFMessageBoxControl;component/Images/Info.png";
                    break;
                case WPFMessageBoxImage.OK:
                    __Source = "pack://application:,,,/WPFMessageBoxControl;component/Images/OK.png";
                    break;
                case WPFMessageBoxImage.Question:
                    __Source = "pack://application:,,,/WPFMessageBoxControl;component/Images/Help.png";
                    break;
                default:
                    __Source = "pack://application:,,,/WPFMessageBoxControl;component/Images/Default.png";
                    break;

...
{
    class RecordViolationNonDubaiArValidation : IValidation
    {
        ...
        public string Validate(UserControl form)
        {
            ...
            vsd.hh.ui.ucRecordViolationNonUAEVehicle validateUserControl = (vsd.hh.ui.ucRecordViolationNonUAEVehicle)form;
            string Valid = "";
            bool validity = true;
            ...
            if (validateUserControl.txtBoxOperatorName.Text == "")
            {
                ...
                Valid += "لم يتم العثور على الشركة" + "\n";
                if (validity)
        ...
        /*
            ...
            if (validateUserControl.txtYear.Text == "")
            {
                ...
                Valid += "يرجى إدخال سنة الصنع" + "\n";
                if (validity)
                    validateUserControl.txtYear.Focus();
                validity = false;
            ...
            if (!(allNumbers))
            {
                ...
                Valid += "يجب أن يكون السنة في أرقام" + "\n";
                if (validity)
                    validateUserControl.txtYear.Focus();
                validity = false;

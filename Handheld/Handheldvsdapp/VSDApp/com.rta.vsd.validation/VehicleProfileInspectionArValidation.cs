...
{
    class VehicleProfileInspectionArValidation : IValidation
    {
        ...
        public string Validate(UserControl form)
        {
            ...
            vsd.hh.ui.ucVehicleSelection validateUserControl = (vsd.hh.ui.ucVehicleSelection)form;
            string Valid = "";
            bool validity = true;
            ...
            {
                validity = false;
                Valid += "حرف غير صالحة في اسم المشغل" + "\n";
